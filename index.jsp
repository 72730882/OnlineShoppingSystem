...
<body>
    ...
    <div class="banner-grid">
        <div id="visual">
            <div class="slide-visua l">
                <ul class="slide-group">              	
                    <li><img class="img-responsive" src="assets/img/homee2 (2).jpg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="assets/img/home1.jpg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="assets/img/homee.jpg" alt="Dummy Image" /></li>            
                                                           
                </ul>
                <div class="script-wrap">
                    <ul class="script-group">
                       <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/homee2 (2).jpg" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/homee1.jpg" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="assets/img/homee.jpg" alt="Dummy Image" />
                            </div></li> 
                    </ul>
